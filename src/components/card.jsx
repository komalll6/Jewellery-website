    ...
    return(
        <div className='flex flex-col items-center'>
            ...
            <div className=' p-5 flex justify-evenly flex-wrap gap-y-3 '>{datas.map((data)=>
                ...
                <div className='h-80 w-60 shadow shadow-gray-400 p-1 flex-col hover:scale-90 duration-300 rounded-lg'>
                <img className='h-55 w-60 object-cover rounded-t-lg ' src={data.image} alt=""/>
